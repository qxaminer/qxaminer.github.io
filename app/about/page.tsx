          ...
          <div className="mx-auto max-w-4xl space-y-8">
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
              ...
              <p className="text-lg leading-relaxed text-foreground">
                With a background in NLP research and currently pursuing a Masters in Creative Technology at SMU, Mister Fields operates at the intersection of artistic practice and technical capability. His work encompasses traditional studio practice—paintings and gallery works—alongside deployed software applications and research prototypes.
              </p>
              ...
              <p className="text-lg leading-relaxed text-foreground">
                Where others see AI as automation, Mister Fields sees translation: between languages, skill levels, and cultural values. His work centers on implementing AI ethics in design—respecting agency, preserving cultural uniqueness, and ensuring human value alignment.
              </p>
